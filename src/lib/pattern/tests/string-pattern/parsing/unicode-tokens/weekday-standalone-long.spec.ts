...
describe('DateTimePattern - weekdayStandaloneLong', () => {
  ...
  describe('es-US locale', () => {
    ...
    it('should parse Sunday (uppercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'es-US', case: 'uppercase', unicode: true });
      const value = pattern.parse('DOMINGO');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (lowercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'es-US', case: 'lowercase', unicode: true });
      const value = pattern.parse('domingo');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (case insensitive)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'es-US', case: 'insensitive', unicode: true });
      const value = pattern.parse('DoMiNgO');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Saturday (default case)', () => {
    ...
    it('should be part of a valid date', () => {
      const pattern = new DateTimePattern('cccc, MMM dd, yyyy', { locale: 'es-US', unicode: true });
  ...
  describe('en-UK locale', () => {
    it('should parse Sunday (default case)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'en-UK', unicode: true });
      const value = pattern.parse('Sunday');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (uppercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'en-UK', case: 'uppercase', unicode: true });
      const value = pattern.parse('SUNDAY');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (lowercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'en-UK', case: 'lowercase', unicode: true });
      const value = pattern.parse('sunday');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (case insensitive)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'en-UK', case: 'insensitive', unicode: true });
      const value = pattern.parse('sUnDaY');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Saturday (default case)', () => {
    ...
    it('should be part of a valid date', () => {
      const pattern = new DateTimePattern('cccc, MMM dd, yyyy', { locale: 'en-UK', unicode: true });
      const value = pattern.parse('Sunday, Jan 05, 2025');
      expect(value.normalized.weekday).toBe(7);
      expect(value.normalized.month).toBe(1);
      expect(value.normalized.day).toBe(5);
  ...
  describe('ru-RU locale', () => {
    ...
    it('should parse Sunday (uppercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'ru-RU', case: 'uppercase', unicode: true });
      const value = pattern.parse('ВОСКРЕСЕНЬЕ');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (lowercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'ru-RU', case: 'lowercase', unicode: true });
      const value = pattern.parse('воскресенье');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (case insensitive)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'ru-RU', case: 'insensitive', unicode: true });
      const value = pattern.parse('ВоскРеСеНьЕ');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Saturday (default case)', () => {
    ...
    it('should be part of a valid date', () => {
      const pattern = new DateTimePattern('cccc, MMM dd, yyyy', { locale: 'ru-RU', unicode: true });
  ...
  describe('ja-JP locale', () => {
    ...
    it('should parse Sunday (uppercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'ja-JP', case: 'uppercase', unicode: true });
      const value = pattern.parse('日曜日');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (lowercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'ja-JP', case: 'lowercase', unicode: true });
      const value = pattern.parse('日曜日');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (case insensitive)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'ja-JP', case: 'insensitive', unicode: true });
      const value = pattern.parse('日曜日');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Saturday (default case)', () => {
    ...
    it('should be part of a valid date', () => {
      const pattern = new DateTimePattern('cccc, MMM月 dd, yyyy', { locale: 'ja-JP', unicode: true });
  ...
  describe('de-DE locale', () => {
    ...
    it('should parse Sunday (uppercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'de-DE', case: 'uppercase', unicode: true });
      const value = pattern.parse('SONNTAG');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (lowercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'de-DE', case: 'lowercase', unicode: true });
      const value = pattern.parse('sonntag');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (case insensitive)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'de-DE', case: 'insensitive', unicode: true });
      const value = pattern.parse('SoNnTaG');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Saturday (default case)', () => {
    ...
    it('should be part of a valid date', () => {
      const pattern = new DateTimePattern('cccc, MMM dd, yyyy', { locale: 'de-DE', unicode: true });
  ...
  describe('fr-FR locale', () => {
    ...
    it('should parse Sunday (uppercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'fr-FR', case: 'uppercase', unicode: true });
      const value = pattern.parse('DIMANCHE');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (lowercase)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'fr-FR', case: 'lowercase', unicode: true });
      const value = pattern.parse('dimanche');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Sunday (case insensitive)', () => {
      const pattern = new DateTimePattern('cccc', { locale: 'fr-FR', case: 'insensitive', unicode: true });
      const value = pattern.parse('DiMaNcHe');
      expect(value.normalized.weekday).toBe(7);
    });
    it('should parse Saturday (default case)', () => {
    ...
    it('should be part of a valid date', () => {
      const pattern = new DateTimePattern('cccc, MMM dd, yyyy', { locale: 'fr-FR', unicode: true });
